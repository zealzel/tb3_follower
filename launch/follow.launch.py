...
def generate_launch_description():
    package_name = "tb3_follower"
    robot_name_in_model = "tb3"
    default_launch_dir = "launch"
    gazebo_models_path = "models"
    map_file_path = "/opt/ros/galactic/share/turtlebot3_navigation2/map/map.yaml"
    nav2_params_path = "config/nav2_object_following_params.yaml"
    ...
    urdf_file_path = (
        "/opt/ros/galactic/share/turtlebot3_description/urdf/turtlebot3_waffle.urdf"
    )
    world_file_path = (
        "/opt/ros/galactic/share/turtlebot3_gazebo/worlds/turtlebot3_world.world"
    )
    ...
    print(f"nav2_params_path: {nav2_params_path}")
